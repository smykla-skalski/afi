...
Text-protocol run_bash arg is `command` (NOT `cmd`): [minion_tool_call]{\"name\": \"run_bash\", \"arguments\": {\"command\": \"ls -la\"}}[/minion_tool_call]";
